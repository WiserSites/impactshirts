...
$options_panel->addSelect('homepage_template', array('default_template' => 'Default Front page template', 'modular_template' => 'Modular template'), array('name' => 'Home page template', 'std' => array('default_template')));
